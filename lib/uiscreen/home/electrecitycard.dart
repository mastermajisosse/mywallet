...
class ElectrrcityCard extends StatefulWidget {
  @override
  _ElectrrcityStateCard createState() => _ElectrrcityStateCard();
}

class _ElectrrcityStateCard extends State<ElectrrcityCard> {
  var _radioValue1 = "";
  @override
