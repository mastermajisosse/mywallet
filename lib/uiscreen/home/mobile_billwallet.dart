...
class MobileBillPage extends StatefulWidget {
  @override
  _MobileBillPageState createState() => _MobileBillPageState();
}

class _MobileBillPageState extends State<MobileBillPage> {
  int _radioValue1;
  @override
